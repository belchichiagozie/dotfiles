{
  programs.plasma = {
    ...
    shortcuts = {
      ActivityManager.switch-to-activity-159e5156-f558-4ca5-ae49-76c6e27ebd50 = [ ];
    ...
    configFile = {
      ...
      kcminputrc."Libinput/1133/50498/Logitech Wireless Receiver Mouse".PointerAcceleration = 0.200;
      ...
      kcminputrc."Libinput/2/7/SynPS\\/2 Synaptics TouchPad".PointerAcceleration = 0.200;
      ...
      krunnerrc."Runners/krunner_quickwebshortcuts".bing_locale = "en-us";
      krunnerrc."Runners/krunner_quickwebshortcuts".clean_history = "quick";
      krunnerrc."Runners/krunner_quickwebshortcuts".google_locale = "en";
      krunnerrc."Runners/krunner_quickwebshortcuts".max_search_suggestions = 10;
      krunnerrc."Runners/krunner_quickwebshortcuts".minimum_letter_count = 3;
      krunnerrc."Runners/krunner_quickwebshortcuts".private_window_action = true;
      krunnerrc."Runners/krunner_quickwebshortcuts".private_window_note = true;
      krunnerrc."Runners/krunner_quickwebshortcuts".private_window_search_suggestions = false;
      krunnerrc."Runners/krunner_quickwebshortcuts".proxy = "disabled";
      krunnerrc."Runners/krunner_quickwebshortcuts".proxy_show_errors = true;
      krunnerrc."Runners/krunner_quickwebshortcuts".search_engine_name = "";
      krunnerrc."Runners/krunner_quickwebshortcuts".search_suggestions = "disabled";
      krunnerrc."Runners/krunner_quickwebshortcuts".show_name = true;
      krunnerrc."Runners/krunner_quickwebshortcuts".show_search_for_note = true;
      krunnerrc."Runners/krunner_quickwebshortcuts".trigger_character = ":";
      krunnerrc."Runners/krunner_quickwebshortcuts".web_shortcut = "/usr/share/kservices5/searchproviders/duckduckgo.desktop";
      kscreenlockerrc."Greeter/Wallpaper/org.kde.image/General".Image = "file:///home/belchi/Pictures/D2_Evergreen_Key-Art_Crops_JB_3840x2160.jpg";
    ...
    dataFile = {
      "kate/anonymous.katesession"."Document 0".URL = "file:///home/belchi/Desktop/to_h264.sh";
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-H-Splitter = "0,1625,0";
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-0-Splitter = 754;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-1-Splitter = 754;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-2-Splitter = 1625;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-3-Splitter = 1331;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-V-Splitter = "0,754,0";
      ...
      "kate/anonymous.katesession"."MainWindow0-Splitter 0".Sizes = 754;
